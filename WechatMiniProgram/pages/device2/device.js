...
i(require("../../2617D5879E166AAF4071BD80CB856D63.js"));
var a = i(require("../../E95DDF379E166AAF8F3BB73069956D63.js"));
...
var s = require("../../9236B3819E166AAFF450DB86EB756D63.js"),
  n = "5.13",
  r = 1,
  l = null,
  S = ["#bt1", "设置电压", "NV", "V", "", ""],
      ...
      if ("设置调压范围" == e) {
        ...
        if (J < 10) Ut("当前电压小于10V 不能进行校正");
          ...
          Ot.includes("Increase") ?
            $t("SetSVF=" + (20 * c).toFixed(2) + "," + (100 * c).toFixed(2)) :
            Ot.includes("Huawei") ?
            $t(
              "SetSVF=" + (41 * c).toFixed(2) + "," + (58.5 * c).toFixed(2)
            ) :
            Ot.includes("ZTE") ?
            $t(
              "SetSVF=" + (41.5 * c).toFixed(2) + "," + (59 * c).toFixed(2)
            ) :
            Ot.includes("EPS") ?
            $t("SetSVF=" + (44 * c).toFixed(2) + "," + (61 * c).toFixed(2)) :
            Ot.includes("INFY");
        }
      else if ("实际输出电流" == e)
...
function Xt(t) {
  for (var e = 0, a = "CAN-", i = 0; i < t.length; i++)
    if (((a += t[i]), t[i].match(/[\u4e00-\u9fa5]/g) ? (e += 3) : e++, e >= 24))
      return a;
  return a;
}
wx.getSystemInfo({
