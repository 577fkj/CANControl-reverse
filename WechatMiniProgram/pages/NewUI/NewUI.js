...
var i, n, a, o, r, l, s, c, f, d = require("../../@babel/runtime/helpers/asyncToGenerator"),
  u = require("../../4E08A4649E166AAF286ECC635736D4C0.js"),
  h = require("../../1C192C069E166AAF7A7F4401A546D4C0.js"),
  S = 0,
  F = 0,
  g = 0,
  x = 0,
...
var et, it, nt, at, ot, rt, lt, st, ct, ft, dt, ut, ht, St, Ft, gt, xt, mt, bt, wt, Nt, Tt, Ct, pt = [],
  Dt = 0;
...
function vt() {
  ...
  })), et = w, xt = O, mt = P, Ft = E, gt = K, St = B, ht = V, ut = M, dt = W, rt = I, lt = D, et = w, ot = C, nt = v, ft = G, ct = y, at = A, it = N, st = T, wt = R, Nt = U, Tt = L, Ct = $, bt = k, S = 0)
}
Page({
  data: {
    rgb: "rgb(0,154,97)",
  ...
  nvbt: function (t) {
    tt("设置输出电压", "范围" + l + "-" + r + "V", (function (t) {
      return J("CheckGPWD=" + t), (t = parseFloat(t)) > r || t < l || !isFinite(t) ? void q("超出设置范围") : (J("SetVA=" + t + "," + v), void J("GetINF"))
    }))
  },
  nabt: function (t) {
    ...
    i.setData({
      ...
      t.trim().split("\n").forEach((function (t) {
        if (console.log("Msg:" + t), t.match(/Receive Data End/)) Dt = 0, pt = [], q("发送完成!");
          ...
          N = j(t, "Mode", ""), "0" == j(t, "OL") ? m = "CAN通讯异常" : "SP" == N ? m = "充电器已关机" : "WT" == N ? m = "等待接入电池" : "A" == N ? m = "正在充电中" : "B" == N ? m = "第二段充电中" : "T" == N ? m = "预约等待中" : "C" == N ? m = "充电完成" : "S" == N && (m = "充电完成(已关机)"), I = Number(j(t, "OW")), Number(j(t, "IW")), P = j(t, "SDT"), y = Number(j(t, "OV")), G = Number(j(t, "OA")), W = j(t, "AH"), M = j(t, "WH"), T = Math.trunc(j(t, "SOC", "100")), C = Number(j(t, "IV", "0")), p = Number(j(t, "IT")), D = Number(j(t, "OT")), V = j(t, "Ti", ""), i.setData({
            NFS: Number(j(t, "NFS", "1"))
          }), vt()
        } else t.startsWith("OV=") ? (y = Number(j(t, "OV")), G = Number(j(t, "OA")), I = Number(j(t, "OW")), vt()) : t.startsWith("USV=") ? (k = Number(j(t, "KSV", "1")), B = Number(j(t, "HQ", "0")), r = Number(j(t, "HSV", "100")), l = Number(j(t, "LSV", "20")), z = Number(j(t, "LSA", "1")), H = Number(j(t, "HSA", "35")), v = Number(j(t, "USA", G)), A = Number(j(t, "USV", y)), K = Number(j(t, "SV2", y)), E = Number(j(t, "SA2", "0")), O = Number(j(t, "SD", "0")), w = Number(j(t, "PON", "0")), i.setData({
          ...
          LSV: l,
          HSV: r
        })) : t.startsWith("KS1=") && (R = j(t, "KS1", "58.8,15").replace("V", ",").split(","), U = j(t, "KS2", "67.2,15").replace("V", ",").split(","), L = j(t, "KS3", "71.4,15").replace("V", ",").split(","), $ = j(t, "KS4", "84,15").replace("V", ",").split(","), i.setData(e(e(e(e(e(e(e(e(e({
        ...
        }, "KRC", Number(j(t, "KRC", "1"))), "LEDK0", Number(j(t, "LED0", "0"))), "LEDK1", Number(j(t, "LED1", "0"))), "LEDK2", Number(j(t, "LED2", "0"))), "Sleep", Number(j(t, "SLP", "0"))), "StartTi", Number(j(t, "STi", "0"))), "WTs", Number(j(t, "WTs", "0"))), "UBLE", j(t, "UBLE", "")), "UPWD", j(t, "UPWD", ""))), vt())
      }))
    }))
  },
  onReady: function () {},
