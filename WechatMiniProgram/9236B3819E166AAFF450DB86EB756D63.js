var e = require("@babel/runtime/helpers/regeneratorRuntime.js"),
  ...
  n = require("D6700B049E166AAFB0166303AB656D63.js"),
  t = [],
  o = "",
  s = "",
  i = "",
                    ...
                    wx.getBLEDeviceServices({
                      ...
                      success: function (r) {
                        ...
                        for (var t = 0; t < r.services.length; t++) {
                          var o;
                          if (
                            ((0, n.print)("BLE:", r.services[t].uuid),
                              "0000FFF0-0000-1000-8000-00805F9B34FB" ===
                              (o = r.services[t].uuid.toUpperCase()))
                          )
                            return (
                    ...
                    wx.getBLEDeviceCharacteristics({
                      ...
                      success: function (r) {
                        if (
                          ((0, n.print)(
                              "BLE:",
                              "Get BLE Device Characteristics OK"
                            ),
                        ...
                        var t, o;
                        (t = r.characteristics[0].uuid.toUpperCase()),
                        (o = r.characteristics[1].uuid.toUpperCase()),
                        ("0000FFF2-0000-1000-8000-00805F9B34FB" === t &&
                          "0000FFF1-0000-1000-8000-00805F9B34FB" === o) ||
                        ("0000FFF1-0000-1000-8000-00805F9B34FB" === t &&
                          "0000FFF2-0000-1000-8000-00805F9B34FB" === o) ?
        ...
        return e().wrap(function (e) {
          for (;;)
            switch ((e.prev = e.next)) {
              ...
              case 12:
                for (
                  c = new ArrayBuffer(n.length), a = new Uint8Array(c), u = 0; u < a.length; u++
                )
                  a[u] = n.charCodeAt(u);
            ...
            switch ((e.prev = e.next)) {
              ...
              case 2:
                ...
                for (
                  ...
                  s[i] = parseInt(n.substr(2 * i, 2), 16);
                return (e.next = 8), p(o);
              case 8:
                return e.abrupt("return", e.sent);
              case 11:
...
module.exports = {
    ...
    wx.onBluetoothDeviceFound(function (r) {
        ...
        if (n) {
          for (var o = 0, s = t; o < s.length; o++) {
            var i = s[o];
            if (i.name === n)
              return (i.rssi = r.devices[0].RSSI), void e(n, i.rssi);
          }
          t.push({
              name: n,
  ...
  onBLECharacteristicValueChange: function (e) {
    wx.onBLECharacteristicValueChange(function (r) {
      for (
        var n = new Uint8Array(r.value), t = "", o = "", s = 0; s < n.length; s++
      )
